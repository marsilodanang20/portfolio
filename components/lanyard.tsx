...
interface BandProps {
    maxSpeed?: number;
    minSpeed?: number;
    isMobile?: boolean; // Add isMobile to props interface
}
        ...
        <>
            ...
            <mesh ref={band}>
                ...
                <meshLineMaterial
                    color="white"
                    depthTest={false}
                    resolution={[1000, 1000]} // Simplified resolution handling
                    useMap
                    map={texture}
                    repeat={[-4, 1]}
                    lineWidth={1}
